...
First I will read in the data from `urchins.csv` and return the first 6 lines for reference.
...
Next I will clean up the column headings to make the data easier to wrangle.
