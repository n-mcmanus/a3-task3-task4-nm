...
```{r}
# created df containing urchin stats of interest
stats_urchins <- urchins_clean %>% 
  group_by(common_name) %>% 
  summarize(mean_size_cm = round(mean(size_cm), digits = 1),  #round() changes sigfigs
